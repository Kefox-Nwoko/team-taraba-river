    ...
    <div className="space-y-8 font-sans font-normal">
      {!selectedFolder ? (
        <div className="space-y-6">
          ...
          <div className="md:sticky md:top-[92px] md:z-40 flex flex-col md:flex-row items-stretch md:items-center justify-between gap-4 p-4 bg-white/95 dark:bg-[#121212]/95 backdrop-blur-xl rounded-2xl border border-slate-200/80 dark:border-slate-800 shadow-xs">
