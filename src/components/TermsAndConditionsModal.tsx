            ...
            <section className="bg-gradient-to-br from-teal-50 to-slate-50 dark:from-teal-950/20 dark:to-slate-800/30 p-6 rounded-2xl border border-teal-100 dark:border-teal-900/40">
              <div className="flex items-start gap-3">
                ...
                <div className="space-y-3 text-sm leading-relaxed">
                  ...
                  <p>
                    USOSA is the umbrella alumni body for all 104 Federal Unity Colleges across Nigeria — institutions founded to foster national unity, academic excellence, and detribalized Nigerian citizenship. Team Taraba River, operating within that proud tradition, is a Port Harcourt-based fellowship group that brings its members together for fun, community support, professional networking, and the celebration of life as old students.
                  </p>
                  <p>
